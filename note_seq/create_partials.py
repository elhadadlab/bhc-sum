...
if __name__ == '__main__':
    ...
    datamodule = SummaryDataModule(args, note_meta_df, tokenizer=tokenizer, notes_to_select='partial')
    ...
    split_str = '_mini' if args.debug else f'_{args.split}'
    max_n_suffix = '' if args.max_examples is None else '_' + str(args.max_examples)
    out_fn = os.path.join(results_dir, f'partial_predictions{split_str}{max_n_suffix}.csv')
